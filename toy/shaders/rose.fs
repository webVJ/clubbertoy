...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	vec4 vol4 = vec4(iMusic[0].z, iMusic[1].z, iMusic[2].z, iMusic[3].z);
    vec4 note4 = vec4(iMusic[0].y, iMusic[1].x, iMusic[2].x, iMusic[3].x);
	vec3 vol3 = vec3(iMusic[0].z, iMusic[1].z, iMusic[2].z);
    vec3 note3 = vec3(iMusic[0].y, iMusic[1].x, iMusic[2].x);
